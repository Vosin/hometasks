...
public class HomeDeviceDemo {
    ...
    public static FlatDevice createFlatDevice(){
        HomeDevice kettle = new KettleHomeDevice(1.20, true, 220);
        HomeDevice iron = new IronHomeDevice(2.5, false, 210);
        HomeDevice hairDryer = new HairDryerHomeDevice(1.5, false, 215);
        HomeDevice iron1 = new IronHomeDevice(2.1, true, 220);
        HomeDevice kettle1 = new KettleHomeDevice(1.8, true, 230);
